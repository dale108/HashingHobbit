...
string cleanWord(string s) {
	...
	// TODO: deal with words that span multiple lines (hyphen at end of line)
	// i.e. compu-
	// ter
	// should be cleaned to word "computer"
	// Note: there should be an alphanumeric character preceding the hyphen
}
